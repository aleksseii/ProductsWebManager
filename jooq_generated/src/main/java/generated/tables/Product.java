...
public class Product extends TableImpl<ProductRecord> {
     ...
     */
    public final TableField<ProductRecord, Integer> COMPANY_ID = createField(DSL.name("company_id"), SQLDataType.INTEGER, this, "");
    ...
    public List<UniqueKey<ProductRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.PRODUCT_PRODUCT_NAME_KEY);
    }
    ...
    public List<Check<ProductRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("non_negative_amount"), "((amount >= 0))", true)
        );
    }
